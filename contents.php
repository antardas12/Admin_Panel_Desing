<?php $page="contents"; include './components/head.php'; ?>
            ...
            <div id="layoutSidenav_content">
                <main>
                        <div class="page-header d-flex justify-content-between px-3">
                            <h4 class="mb-0">    
                                <a class="text-dark" style="text-decoration:none" href="">Contents</a>
                            </h4>
                            <div class="btns">
                                <a href="./new_content" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> New content</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="d-flex" style="gap:4px;">
                                                <a href="./view_content" class="btn btn-sm btn-info text-light">View/Edit</a>
