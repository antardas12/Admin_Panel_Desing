...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row" id="form">
						<form control="" class="form-group">
							...
							<div class="row mb-3">
                                ...
                                <div class="pass-con">
                                    <input type="password" name="cnf_pass" id="cnf_pass" class="form-control" placeholder="Confirm Password">
                                </div>
							</div>
							
							<div class="row">
								<!-- <input type="submit" value="Login" class="btn btn-primary"> -->
                                <a href="./verify_otp" class="btn btn-primary">Change  Password</a>
							</div>
        ...
        <script>
            ...
            let cnfPassInput = document.getElementById('cnf_pass');
            let viewToggle = document.querySelector('.pass-btn');
            viewToggle.addEventListener('click',()=>{
                if (passInput.type === 'password') {
                        passInput.type = 'text';
                        cnfPassInput.type = 'text';
                    } else {
                        passInput.type = 'password';
                        cnfPassInput.type = 'password';
                    }
            })
        </script>
    </body>
